"""Build a report using the seeded local SentinelAPI API contract.
...
def main() -> None:
    ...
    bola_request = {
        "method": "GET",
        "url": "http://127.0.0.1:8000/orders/1002",
    ...
    findings.extend(
        check_excessive_data_exposure(
            ...
            response_body={
                "id": 1002,
                "owner_id": 2,
                "item_name": "SentinelAPI Mug",
                "internal_notes": "Do not disclose this internal fulfillment note.",
                "payment_reference": "pay_demo_b_1002",
            },
            request=bola_request,
        )
    )
    findings.extend(
        check_rate_limit_observation(
            ...
            request={
                ...
                "json": {"email": "user-a@example.test", "password": "demo-password-a"},
            },
        )
    )
